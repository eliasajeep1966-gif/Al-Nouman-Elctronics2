    ...
    <div className={`bg-white rounded-2xl shadow-md border transition-all hover:shadow-xl hover:-translate-y-1 duration-300 fade-in ${
      ...
      <div className="p-4">
        ...
        {product.specifications && (
          <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl px-3 py-2.5 mb-3 border border-amber-200">
            <div className="flex items-start gap-2">
              <span className="text-amber-500 text-sm">📝</span>
              <div>
                <p className="text-xs font-semibold text-amber-700 mb-0.5">المواصفات</p>
