...
- [x] إضافة نظام المصادقة (تسجيل الدخول، إنشاء حساب، استعادة كلمة المرور) للموقع الإلكتروني (نفس منطق الموبايل)
- [x] إضافة نظام المصادقة (تسجيل الدخول، إنشاء حساب، استعادة كلمة المرور) للتطبيق الموبيلي
...
| 2026-03-11 | إصلاح أخطاء Console: مشكلة null في LogTab، مشكلة Clipboard API، إزالة duplicate props في LoginScreen |
| 2026-03-10 | إضافة نظام المصادقة (تسجيل الدخول، إنشاء حساب، استعادة كلمة المرور) للتطبيق الموبيلي |
| 2026-03-10 | إضافة نظام المصادقة للموقع الإلكتروني (نسخة من الموبايل) |
| 2026-03-10 | إصلاح مشكلة استمرار جلسة المصادقة في الموقع الإلكتروني (persistSession, detectSessionInUrl) |
